...
// total number of bits per common shift register (CSR))
#define TLC5947_NO_OF_BITS_PER_CSR              (TLC5947_NO_OF_CHIPS * TLC5947_NO_OF_CHANNELS_PER_CHIP * TLC5947_NO_OF_GS_BITS_PER_CHANNEL) // no_of_chips * 288u
// total number of bytes per common shift register (CSR))
#define TLC5947_NO_OF_BYTES_PER_CSR             (TLC5947_NO_OF_BITS_PER_CSR / (8u)) // no_of_chips * 36
...
#define TLC5947_GS_DATA_INVERT(value)           (TLC5947_GS_DATA_MAX_VALUE-value)
/* ========================================================================== */
...
typedef struct _tlc5947_t {
    ...
    uint8_t common_shift_register[TLC5947_NO_OF_BYTES_PER_CSR];
    uint8_t receive_register[TLC5947_NO_OF_BYTES_PER_CSR];
